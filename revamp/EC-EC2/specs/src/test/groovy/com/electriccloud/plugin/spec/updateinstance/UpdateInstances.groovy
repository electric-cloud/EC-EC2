...
//    ]
    ...
    def 'complex update'() {
        ...
        instances.each {
            ...
            assert helper.getInstanceAttribute(it).userData().value() == 'test user data'
            assert helper.getInstanceAttribute(it).instanceInitiatedShutdownBehavior().value() == "terminate"
        }
    }
