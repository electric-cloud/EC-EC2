    ...
    extends ListBase
{
    ...
    public ConfigurationList()
    {
        ...
        super("ecgc", "EC2 Configurations", "All Configurations");
        m_configList = new EC2ConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        Loader loader = new EC2ConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-EC2/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            ClickHandler dch = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the EC2 configuration '"
                            + configName + "'?") {
