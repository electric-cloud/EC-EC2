...
// EC2ConfigList.java --
//
// EC2ConfigList.java is part of ElectricCommander.
//
...
public class EC2ConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, EC2ConfigInfo> m_configInfo =
        new TreeMap<String, EC2ConfigInfo>();
    ...
    public void addConfig(
            ...
            String configServer)
    {
        m_configInfo.put(configName, new EC2ConfigInfo(configServer));
    }
    ...
    private class EC2ConfigInfo
    {
        ...
        public EC2ConfigInfo(String server)
        {
            m_server = server;
        }
    }
